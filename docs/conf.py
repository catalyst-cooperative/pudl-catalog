...
release = pkg_resources.get_distribution("catalystcoop.pudl_catalog").version

# -- Project information -----------------------------------------------------

project = "PUDL Data Catalog"
copyright = (  # noqa: A001
    f"2021-{datetime.date.today().year}, Catalyst Cooperative, CC-BY-4.0"
)
...
# GitHub repo
issues_github_path = "catalyst-cooperative/pudl-catalog"
...
intersphinx_mapping = {
    ...
    "gcsfs": ("https://gcsfs.readthedocs.io/en/stable/", None),
